...
public final class AccelerometerNetworking {
    ...
    public byte[] serializeAccelerometer(InputObject.AccelerometerObject accelerometer){
        ...
        array[0]=0;
        ByteBuffer.wrap(array,1,4).order(ByteOrder.BIG_ENDIAN).putFloat(accelerometer.x);
        ByteBuffer.wrap(array,5,4).order(ByteOrder.BIG_ENDIAN).putFloat(accelerometer.y);
        return array;
    }
    ...
    public InputObject.AccelerometerObject deserializeAccelerometer(byte[] array){
        ...
        accelerometer.x=ByteBuffer.wrap(array,1,4).order(ByteOrder.BIG_ENDIAN).getFloat();
        accelerometer.y=ByteBuffer.wrap(array,5,4).order(ByteOrder.BIG_ENDIAN).getFloat();
